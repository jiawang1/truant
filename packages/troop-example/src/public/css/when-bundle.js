...
(function(define) {
define('when/callbacks',['require','./when','./lib/liftAll','./lib/apply'],function(require) {
...
(function(define) {
define('when/function',['require','./when','./lib/liftAll','./lib/apply'],function(require) {
...
define('when/monitor/error',[],function() {
	...
	function useStackLazily(host) {
		var error = new Error();
		Object.defineProperty(host, 'stack', {
			get: function() {
				return error.stack;
			}
		});
...
(function(define) { 'use strict';
define('when/monitor/PromiseMonitor',['require','../lib/env','./error'],function(require) {

	var defaultStackJumpSeparator = 'from execution context:';
	var defaultStackFilter = /[\s\(\/\\](node|module|timers)\.js:|when([\/\\]{1,2}(lib|monitor|es6-shim)[\/\\]{1,2}|\.js)|(new\sPromise)\b|(\b(PromiseMonitor|ConsoleReporter|Scheduler|RunHandlerTask|ProgressTask|Promise|.*Handler)\.[\w_]\w\w+\b)|\b(tryCatch\w+|getHandler\w*|useStackDirectly|useStackLazily|captureSpiderMonkeyStack)\b/i;
...
(function(define) {
define('when/node',['require','./when','./lib/liftAll','./lib/env','./lib/apply'],function(require) {
